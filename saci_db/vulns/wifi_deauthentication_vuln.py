            ...
            attack_vectors = [
                {
                    ...
                    "comp_attack_effect": BaseCompEffect(category="Avialability", 
                ...
                },
                {
                    ...
                    "attack_vector": [BaseAttackVector(name="Deauthentication Attack to Hijack Control",
                                                    signal=PacketAttackSignal(src=ExternalInput(), dst=Wifi()),
                                                    required_access_level="Proximity")],
                    # List of associated CPVs
                ...
                },
                {
                    ...
                    "attack_vector": [BaseAttackVector(name="Telnet Access for Root Control",
                ...
                },
                {
                    ...
                    "attack_vector": [BaseAttackVector(name="FTP Exploitation to Extract Data",
                    ...
                    # List of associated component-level attack effects
                    "comp_attack_effect": BaseCompEffect(category="Confidentiality", 
