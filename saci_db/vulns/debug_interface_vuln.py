        ...
        super().__init__(
            ...
            attack_vectors_exploits = [
                {   
                    ...
                    "attack_vector": [BaseAttackVector(name='Debug Command Injection Attack',
                                               signal=SerialAttackSignal(src=ExternalInput(), dst=Debug(), data="specific sequence of bytes"),
