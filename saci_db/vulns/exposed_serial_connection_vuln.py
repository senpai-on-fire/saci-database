...
class ExposedSerialConnectionVuln(BaseVulnerability):
    def __init__(self):
        super().__init__(
            component = Serial(),
            ...
            attack_ASP=ExposedSerialConnectionPred,

            rulefile=os.path.join(os.path.dirname(os.path.realpath(__file__)), 'exposed_serial_connection.lp'),
