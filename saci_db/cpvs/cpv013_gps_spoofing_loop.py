...
class GPSSpoofingLoopCPV(CPV):
    ...
    def __init__(self):
        super().__init__(
            ...
            attack_vectors=[
                BaseAttackVector(
                    name="GPS Spoofing Signal Injection",
            ...
            exploit_steps=[
                ...
                "Check if there's a GPS receiver on the CPS. Configure the HackRF device and replace the GPS antenna.",
