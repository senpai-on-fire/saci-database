...
class GNSSLoiterModeSpoofingCPV(CPV):
    ...
    def __init__(self):
        super().__init__(
            ...
            goals=["Gradually displace CPS from its loiter position to a target location"],
        ...
        self.goal_state = ["CPS reaches the target location while maintaining loiter behavior"]
