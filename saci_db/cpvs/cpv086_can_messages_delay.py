...
#Should the Waveshare board and CAN shield be modelled or they are part of the CAN component ? 

 
class CANMessagesDelayCPV(CPV):

    NAME = "PWM generation process starvation using CAN bus flooding. (This is just a hypothesis, not really a full CPV)"
