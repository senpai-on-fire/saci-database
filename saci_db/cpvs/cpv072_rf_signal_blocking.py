...
from saci.modeling.device import GCS, Mavlink, Wifi, TelemetryHigh, SikRadio, ESC, PWMChannel, MultiCopterMotor, ExpressLRSBackpack
        ...
        super().__init__(
            ...
            exploit_steps = [
                ...
                "TA3 Exploit Steps",
                    ...
                    "       2- Remote Controller",
                    "   Steps: "
                    "       1.	Place the drone in an open Ramsey box.",
            ...
            associated_files=["https://github.com/senpai-on-fire/owlet-taskboard/blob/main/CPVs/HII-GS0409380007-CPV008/HII-GS0409380007-CPV008.mp4"],
            reference_urls=["https://github.com/senpai-on-fire/owlet-taskboard/blob/main/CPVs/IVV_Feedback/PASS/HII-GS0409380007-CPV008-202503061.docx"]
        )
