...
class SerialOverheatingCPV(CPV):
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            attack_vectors=[
                BaseAttackVector(
                    name="Serial Duty_speed_up Command Injection",
                    signal=SerialAttackSignal(
                        src=ExternalInput(), dst=Serial(), data="set duty_spup 100"
                    ),
            ...
            attack_impacts=[
                BaseAttackImpact(
                    category="Damage to Property", description="Motors will overheat"
                ),
            ],
