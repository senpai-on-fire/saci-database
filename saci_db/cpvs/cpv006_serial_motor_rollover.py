...
class SerialRollOverCPV(CPV):
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            attack_vectors=[
                BaseAttackVector(
                    name="Serial DSHOT_3D_MODE_ON Commands Injection",
                    signal=SerialAttackSignal(
                        src=ExternalInput(), dst=Serial(), data="10"
                    ),
                    configuration={"repetition": "6"},
                    required_access_level="Physical",
                ),
                BaseAttackVector(
                    name="Serial DSHOT_CMD_SAVE_SETTINGS Commands Injection",
                    signal=SerialAttackSignal(
