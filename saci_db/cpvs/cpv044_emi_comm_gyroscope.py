    ...
    def __init__(self):
        super().__init__(
            ...
            exploit_steps=[
                ...
                "       + Gyroscope sensor outputs at bit level",
                "       + Gyroscope-Controller communication channel at bit level",
                ...
                "TA3-3) Identify the gyroscope's serial communication channel protocol and transmission frequency",
