...
from saci.modeling.device import Wifi, Mavlink, ESC, PWMChannel, MultiCopterMotor, ExpressLRSBackpack, GCS
    ...
    def __init__(self):
        super().__init__(
            ...
            attack_vectors = [BaseAttackVector(name="MavLink Packets Injection",
                                               signal=PacketAttackSignal(src=Mavlink(), dst=ExpressLRSBackpack()), #may need to change TXBackpack to Telem
