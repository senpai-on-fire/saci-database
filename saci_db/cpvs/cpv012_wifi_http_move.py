...
class WifiWebMoveCPV(CPV):
    ...
    def __init__(self):
        super().__init__(
            ...
            attack_vectors=[
                BaseAttackVector(
                    name="Move Button Manipulation via HTTP Requests Injection",
            ...
            associated_files=[],
            reference_urls=[
                "https://github.com/senpai-on-fire/NGC1B-CPS-CPVs/blob/main/CPV009/HII-NGP1AROV1ARR03-CPV009-20240911.docx"
            ],
        )
