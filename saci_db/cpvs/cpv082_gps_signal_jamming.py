...
class GPSJammingNoDriveCPV(CPV):
    ...
    def __init__(self):
        super().__init__(
            ...
            vulnerabilities=[GPSJammingVuln()],
            ...
            attack_vectors=[BaseAttackVector(
                name="GPS Signal Jamming via SDR",
                signal=GPSAttackSignal(src=ExternalInput(), dst=GPSReceiver()),
                required_access_level="Proximity",
                configuration={"frequency": "GPS L1", "spoofing": False, "jamming": True, "duration": "Continuous"},
            )],

            attack_impacts=[BaseAttackImpact(
            ...
            associated_files=["GIGA-R1-firmware-model.docx", "brdc2550.24n", "command.txt"],
            reference_urls=[
