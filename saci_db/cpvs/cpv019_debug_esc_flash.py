        ...
        super().__init__(
            ...
            attack_vectors=[
                BaseAttackVector(
                    ...
                    ),  # command: need to check what the specific sequence of bytes is
                    required_access_level="Physical",
                )
            ],
            attack_impacts=[BaseAttackImpact(category="Denial of control", description="Motor stops spinning")],
            exploit_steps=[
                "TA1 Exploit Steps",
