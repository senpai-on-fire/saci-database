    ...
    def __init__(self):
        super().__init__(
            ...
            exploit_steps=[
                ...
                "       + Magnetometer sensor outputs at bit level",
                "       + Magnetometer-Controller communication channel at bit level",
                ...
                "TA3-3) Identify the magnetometer's serial communication channel protocol and transmission frequency",
                ...
                "   - Monitor the UAV for signs of flight instability or orientation errors caused by corrupted magnetometer data."
            ],
