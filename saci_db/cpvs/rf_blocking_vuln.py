...
class RFBlockingPred(Predicate):
    pass


class RFBlockingVuln(PublicSecretVulnerability):
    def __init__(self):
        super().__init__(
    ...
    def exists(self, device: Device) -> bool:
        ...
        for comp in device.components:
            ...
            if isinstance(comp, Wifi) or isinstance(comp, SikRadio) or isinstance(comp, Telemetry):
