    ...
    def __init__(self):
        super().__init__(
            required_components=[
                ...
                Steering(),  # This is the exit component + Changed to Motor() for generalization (Required)
            ],
            ...
            exploit_steps=[
                ...
                "TA3 Exploit Steps",
                "A- Reverse Engineering   1-Use optical imaging tools to catalog all of the components on the CPS.",
            ...
            associated_files=[
                "https://github.com/senpai-on-fire/ngc2_taskboard/blob/main/CPVs/HII-NGP1AROV2ARR05-CPV007/hii_cpv007_terminate_passthrough.mp4"
            ],
            reference_urls=[
