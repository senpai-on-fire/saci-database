...
class EMISpoofingMagnetometerCPV(CPV):
    ...
    def __init__(self):
        super().__init__(
            ...
            vulnerabilities=[MagnetometerSpoofingVuln(), LackEMISensorShieldingVuln(), LackEMIPowerCableShieldingVuln(), ControllerIntegrityVuln()],
            ...
            associated_files=["https://github.com/senpai-on-fire/ngc2_taskboard/blob/main/CPVs/HII-NGP1AROV2ARR05-CPV014/CPV_video_clips_v2.compressed.mp4"],
            reference_urls=[
