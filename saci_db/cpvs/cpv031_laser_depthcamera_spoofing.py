...
from saci.modeling.device import Serial, DepthCamera, PWMChannel, ESC, MultiCopterMotor
...
class DepthCameraDoSCPV(CPV):
    ...
    NAME = "The Laser Spoofing on Depth Camera Sensors"
    ...
    def __init__(self):
        super().__init__(
            ...
            vulnerabilities=[DepthCameraSpoofingVuln(), ControllerIntegrityVuln()],
