    ...
    def __init__(self, state=None):
        ...
        components = { ComponentID('gcs'): gcs, ComponentID('sik'): sik, ComponentID('dsmx'): dsmx, ComponentID('mavlink'): mavlink, ComponentID('icmp'): icmp, ComponentID('wifi'): wifi, ComponentID('propriety_telemetry'): propriety_telemetry, ComponentID('gps'): gps, ComponentID('gps_serial'): gps_serial, ComponentID('accel'): accel, ComponentID('accel_serial'): accel_serial, ComponentID('gyro'): gyro, ComponentID('gyro_serial'): gyro_serial, ComponentID('magnet'): magnet, ComponentID('magnet_serial'): magnet_serial,\
                      ComponentID('baro'): baro, ComponentID('baro_serial'): baro_serial, ComponentID('camera'): camera, ComponentID('dnn_tracking'): dnn_tracking, ComponentID('dnn_obstacle'): dnn_obstacle, ComponentID('depth_camera'): depth_camera, ComponentID('obstacle'): obstacle, ComponentID('optical_camera'): optical_camera, ComponentID('emergency_stop'): emergency_stop, ComponentID('speed_control'): speed_control, ComponentID('attitude_control'): attitude_control,\
                        ComponentID('navigation_control'): navigation_control, ComponentID('propriety_cont'): propriety_cont, ComponentID('pwm_channel'): pwm_channel, ComponentID('esc'): esc, ComponentID('motor'): motor, ComponentID('gnss_serial'): gnss_serial, ComponentID('gnss'): gnss }
        ...
        entry_points = {ComponentID('gcs'): True, ComponentID('sik'): False, ComponentID('dsmx'): False, ComponentID('mavlink'): False, ComponentID('icmp'): False, ComponentID('wifi'): True, ComponentID('propriety_telemetry'): False, ComponentID('gps'): True, ComponentID('gps_serial'): False, \
                        ComponentID('gnss'): True, ComponentID('gnss_serial'): False, ComponentID('accel'): True, ComponentID('accel_serial'): True, ComponentID('gyro'): True, ComponentID('gyro_serial'): True, ComponentID('magnet'): True, ComponentID('magnet_serial'): True,\
                        ...
                        ComponentID('navigation_control'): True, ComponentID('propriety_cont'): False, ComponentID('pwm_channel'): True, ComponentID('esc'): False, ComponentID('motor'): False}
