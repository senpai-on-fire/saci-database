...
class ArduPilotQuadcopter(Device):
    ...
    def __init__(self, state=None):
        ...
        components = {
            ...
            ComponentID("ard"): ard,
            ComponentID("ardu_telemetry"): ardu_telemetry,
            ComponentID("gps"): gps,
