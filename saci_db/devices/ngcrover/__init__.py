...
class NGCRover(Device):
    ...
    def __init__(self, state=None):
        ...
        components = {
            ...
            ComponentID("webserver"): webserver,
            ComponentID("gps"): gps,
            ComponentID("compass"): compass,
            ComponentID("uno_r4"): uno_r4,
            ComponentID("serial"): serial,
            ComponentID("uno_r3"): uno_r3,
            ComponentID("pwm_channel_esc"): pwm_channel_esc,
            ComponentID("pwm_channel_servo"): pwm_channel_servo,
            ComponentID("esc"): esc,
        ...
        component_graph = nx.from_edgelist(
            [
                (ComponentID("wifi"), ComponentID("webserver")),
                ...
                (ComponentID("pwm_channel_servo"), ComponentID("steering")),
            ],
